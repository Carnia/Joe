...
<script src="<?php $echo autoNpmCdnUrl('typecho-joe-next@6.0.0/plugin/sketchpad/joe.sketchpad.js') ?>"></script>
<script src="<?php $echo autoNpmCdnUrl('@fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.js') ?>"></script>
<script src="<?php $echo autoNpmCdnUrl('typecho-joe-next@6.0.0/assets/js/joe.extend.min.js') ?>"></script>
<script src="<?php $echo autoNpmCdnUrl('typecho-joe-next@6.0.0/plugin/qmsg/qmsg.js') ?>"></script>
<?php if ($this->options->JAside_3DTag !== 'off') : ?>
	<script src="<?php $echo autoNpmCdnUrl('typecho-joe-next@6.2.3/plugin/3dtag/3dtag.min.js') ?>"></script>
<?php endif; ?>
<script src="<?php $echo autoNpmCdnUrl('typecho-joe-next@6.0.0/plugin/smooth/joe.smooth.js') ?>" async></script>
